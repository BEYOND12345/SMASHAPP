/*
  # Update Invoice Creation for Public Sharing

  ## Purpose
  Modify the invoice creation function to automatically set is_public=true
  and generate approval tokens for public sharing.

  ## Changes
  - Update create_invoice_from_accepted_quote function
  - Set is_public=true for all new invoices
  - Ensure approval_token is generated (handled by default)
*/
