...
BEGIN
  ...
  IF is_uuid THEN
    ...
    SELECT json_build_object(
      ...
      'subtotal', q.subtotal_cents / 100.0,
      'tax', q.tax_total_cents / 100.0,
      'total', q.grand_total_cents / 100.0,
...
BEGIN
  ...
  IF is_uuid THEN
    ...
    SELECT json_build_object(
      ...
      'tax', i.tax_total_cents / 100.0,
      'total', i.grand_total_cents / 100.0,
      'amount_paid', i.amount_paid_cents / 100.0,
      'amount_due', (i.grand_total_cents - i.amount_paid_cents) / 100.0,
