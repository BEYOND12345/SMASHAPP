/*
  ...
  1. Changes
    - Update function to not reference non-existent org columns
    - Make function safer by handling missing data gracefully
    - Return profile data directly without org defaults
    
  2. Notes
    - Organizations table doesn't have tax/currency defaults yet
    - Profile has all needed data already
*/
